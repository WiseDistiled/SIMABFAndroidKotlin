...
class RetrofitProviderImpl(private val gson: Gson, private val authenticator: APIAuthenticator, internal var myEmulatorDetector: MyEmulatorDetector, internal var preferences: MyPreferences, private val bus: Bus) : RetrofitProvider {
    ...
    val retrofit: Retrofit
        get() {
            try {
                ...
                val username = authenticator.login
                val password = authenticator.password
                val logging = HttpLoggingInterceptor(object : HttpLoggingInterceptor.Logger {
                    override fun log(message: String) {
                        Timber.tag("RETROFIT").i(message)
                    }
                })
                        ...
                        .addInterceptor(object : Interceptor {
                            ...
                            override fun intercept(chain: Interceptor.Chain): Response {
                                ...
                                val requestBuilder = original.newBuilder().addHeader("Accept", "application/json")
                                        .addHeader("mobilePhone", username.toString())
                                        .addHeader("username", username.toString())
                                        .addHeader("password", password.toString())
                                        .addHeader("authorization", "Bearer " + preferences.token)
                                        .addHeader("Utilisateur-Agent", "SIMABF Android")
