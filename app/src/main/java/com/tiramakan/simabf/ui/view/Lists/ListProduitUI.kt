...
import com.tiramakan.simabf.ui.view.recyclers.RecyclerViewAdapterProduit
 ...
 *
 *
 * Activities containing this fragment MUST implement the [ListProduitUI]
 * interface.
 */
/**
 ...
 */
class ListProduitUI : BaseFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.produit_item_list, container, false)
        ...
        val produits = serviceProvider.service.produits
        produits.sort("nom", Sort.ASCENDING)
        val recyclerViewAdapterDepot = produits.let { RecyclerViewAdapterProduit(context,it) }
