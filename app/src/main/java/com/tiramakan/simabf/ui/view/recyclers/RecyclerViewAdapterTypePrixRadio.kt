 ...
 * specified [RecyclerViewAdapterTypePrixRadio].
 * TODO: Replace the implementation with code for your data type.
 */
class RecyclerViewAdapterTypePrixRadio(private val context: Context, private var mValues: ArrayList<TypePrixUIModel>?, private val clickListener: VHItem.ClickListener) : SelectableAdapter<RecyclerViewAdapterTypePrixRadio.VHItem>() {

    val selectedItem: TypePrixUIModel?
        get() {
    ...
    fun setItems(items: ArrayList<TypePrixUIModel>) {
        this.mValues = items
    ...
    class VHItem(var mView: View, private val listener: ClickListener?) : RecyclerView.ViewHolder(mView), View.OnClickListener, View.OnLongClickListener {
        ...
        var mItem: TypePrixUIModel? = null
