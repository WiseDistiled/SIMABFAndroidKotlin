 ...
 * specified [RecyclerViewAdapterTypeGeoRadio].
 * TODO: Replace the implementation with code for your data type.
 */
class RecyclerViewAdapterTypeGeoRadio(private val context: Context, private var mValues: ArrayList<TypeGeoUIModel>, private val clickListener: VHItem.ClickListener) : SelectableAdapter<RecyclerViewAdapterTypeGeoRadio.VHItem>() {

    val selectedItem: TypeGeoUIModel?
        get() {
    ...
    fun setItems(items: ArrayList<TypeGeoUIModel>) {
        this.mValues = items
