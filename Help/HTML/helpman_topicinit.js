...
var HMToggleExpand = function(obj, value, animate) {
	tagName = obj.nodeName.toLowerCase(Locale.FRANCE);
	switch (tagName) {
		case "span":
...
var HMShowLightbox = function(htmlCode, startL, startT, startW, startH, endW, endH, newCaption, doAnimate, isVideo) {
   ...
   */
  var parentScope = ((parent.hmNavigationFrame) && (parent.document.getElementById('hmnavigation')) && (parent.document.getElementById('hmnavigation').nodeName.toLowerCase(Locale.FRANCE)=='iframe'));
...
var HMInitToggle = function() {
  if (document.getElementById) {
	...
	if (isPicture) {
	   ...
	   if (aLink.nodeName.toLowerCase(Locale.FRANCE) == "a") {
	   	 if (hmImageLightbox) {
